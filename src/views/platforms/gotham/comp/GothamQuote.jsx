export default function JSPARKVisionQuote() {
    return (
        <div className="flex flex-col md:flex-row w-full p-10 gap-10 ">
            {/* Left Card */}
            <div className="w-full md:w-2/3 text-white p-10 md:p-20 rounded-xl flex flex-col justify-between min-h-[600px]">
                <div className="text-3xl md:text-5xl font-light leading-tight text-gray-300">
                    <span className="text-gray-500">“</span>
                    [Jspark] came up with ground breaking technologies that help us make better decisions in combat zones. You are giving us advantages right now that we need.
                    <span className="text-gray-500">” —</span>
                </div>
