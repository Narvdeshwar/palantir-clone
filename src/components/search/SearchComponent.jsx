    ...
    <div className="bg-[#1E2124] h-screen flex flex-col justify-center">
      <div className="h-[80vh] ">
        ...
        <div className="w-[98%] flex flex-col gap-3 h-full">
          <div className="h-ful flex flex-col mt-46">
            <FormFields
              type="text"
              className="text-white! border! p-3 focus:border-gray-700 transition-all duration-700 w-[95%] mx-auto"
